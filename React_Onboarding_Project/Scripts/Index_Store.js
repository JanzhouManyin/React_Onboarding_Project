...
class InsertStoreModal extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(e) {
        ...
        if (validate) {
            ...
            $.ajax({
                type: "Post",
                url: "/Store/InsertDataInDatabase",
                data: item,
                success: function (result) {
                    //determing if the Store name already exsts
                    if (result == "no") {
                        alert("This Store is already existing, please input again")
                    } else {
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="InsertModalLabel">Create Store</h5>
...
class UpdateStoreModal extends React.Component {
    ...
    handleSubmit(e) {
        ...
        if (validate) {
            ...
            $.ajax({
                type: "Post",
                url: "/Store/UpdateDataInDatabase",
                data: item,
                success: function (result) {
                    //determing if the Store name already exsts
        ...
        return (
            <div className="modal fade" id="updateModal" tabIndex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="updateModalLabel">Edit Store</h5>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div className="modal-body">
                            <form className="ui form" onSubmit={this.handleSubmit} noValidate>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="submit" className="ui green button">Update Store</button>
                                </div>
                            </form>
...
//set List component
class StoreListBox extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        $.get("/Store/GetStoreData", function (data) {
            this.setState({
                totalData: data,
    ...
    handleDelete(StoreId) {
        $.ajax({
            ...
            success: function (result) {
                //determing if the Store is already existing in productsold
                if (result == "use") {
                    alert("This Store is already existing, please input again")
                    window.location.href = "/Store/Index";
                } else {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <InsertStoreModal />
                <UpdateStoreModal Name={modal_Name} Address={item_address} id={item_Id} />
...
ReactDOM.render(
    <StoreListBox dataUrl="/Store/GetStoreData" />,
    document.getElementById('Store_main')
);